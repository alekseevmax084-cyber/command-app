...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      'bg-[var(--surface)] border border-[var(--border-dim)] text-[var(--text-1)]',
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'px-3 py-1.5 text-sm text-[var(--text-1)] outline-none',
      'focus:bg-[var(--surface)] data-[disabled]:opacity-50 data-[disabled]:pointer-events-none',
      className
    )}
    {...props}
  >
